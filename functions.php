...
function do_photo($imgname,$gallery=NULL,$alt=NULL) {
	...
	if (check_mobile()==true) {
		...
		echo "<li itemscope itemtype=\"https://schema.org/ImageObject\" itemprop=\"hasPart\">
		  <a role=\"button\" href=\"$phopath/$imgname.jpg\" class=\"imglink\" data-title=\"$gallery\" data-alt=\"$alt\" aria-haspopup=\"dialog\" itemprop=\"contentUrl\">
			<img src=\"$phopath/$imgname-ico.jpg\" alt=\"$alt\" loading=\"lazy\" width=\"$tnwidth\" height=\"$tnheight\" itemprop=\"thumbnailUrl\" /></a>
		  <meta itemprop=\"dateCreated\" content=\"$gallery\" />
		  <meta itemprop=\"name\" content=\"$imgname\" />
...
function display_news($newsnum,$pubdate,$title,$description) {
	echo "<article aria-labelledby=\"".$newsnum."time\">
		...
		<h2 id=\"".$newsnum."h1\" itemprop=\"headline\">".$title."</h2>
		...
		if (check_mobile()==false) {
			echo "<div class=\"sharelinks\">";
				...
				//facebook share
				echo "<div class=\"shareitem\" role=\"group\" aria-label=\"share item on facebook\">
					<div class=\"fb-share-button\"
						data-href=\"https://www.tmitg.com/news.php?item=".$newsnum."\"
