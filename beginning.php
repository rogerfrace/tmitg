<?php $fbog = array(
	...
	'og:image:alt'=>'Album cover artwork for the Machine in the Garden The Beginning of All Things',
...
<section id="discog_albuminfo" tabindex="-1">
	<div>
		<picture>
			<source srcset="albums/beginninglg.jpg 2x">
				<img src="albums/beginning.jpg" fetchpriority="high" loading="eager" decoding="async" alt="The Beginning of All Things (2026) single cover — the Machine in the Garden" class="albumimg" itemprop="image" />
		</picture>
	</div>
...
<table>
	<caption class="wai">Track listing for "The Beginning of All Things"</caption>
	<thead>
		<tr>
...
<section id="discog_buynow" tabindex="-1" itemprop="offers" itemscope itemtype="https://schema.org/AggregateOffer">
	...
	<div class="buynow" itemprop="offers" itemscope itemtype="https://schema.org/Offer"><meta itemprop="seller" content="Bandcamp"><meta itemprop="priceCurrency" content="USD"><meta itemprop="price" content="0.00"><a rel="noopener noreferrer" itemprop="url" href="https://tmitg.bandcamp.com/track/the-beginning-of-all-things-single-edit" onclick="gtag('event','add_to_cart',{'event_category':'ecommerce','event_label':'Bandcamp'});"><img src="images/bandcamp.png" width="200" height="73" class="bandcamp" alt="Available at Bandcamp" /></a></div>
...
<section aria-labelledby="reviews">	
	<h2 id="reviews" tabindex="-1">Reviews of <i>The Beginning of All Things</i>:</h2>
