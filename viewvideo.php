...
#underworld
		case "finalform":
			...
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/AOV5BxJdeRg?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "finalform2":
...
#winters
		case "control":
			...
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/91w_v5eb3fc?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "control-vid":
			...
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/sXxTMshSwwk?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "miserere-fan":
			...
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/hYvs45o2Itw?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "miserere-fan2":
			$stitle="&ldquo;Miserere Mei&rdquo; (Fan Video)";
			...
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/ZPQx9-y0tsc?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "miserere-fan3":
			$stitle="&ldquo;Miserere Mei&rdquo; (Fan Video)";
			$sdesc="An alternate &quot;Miserere Mei&quot; from the anime, Black Cat. The song is from their album &quot;One Winter&#039;s Night&hellip;&quot;.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/VN2kJj5T7js?si=71EzQBiMXIXnRS_r" frameborder="0" allowfullscreen></iframe>';
			break;
		case "sleepofangels":
			$stitle="&ldquo;The Sleep of Angels&rdquo; (Live 2004)";
			$sdesc="Filmed at Elysium in Austin, TX on August 30, 2004.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/ftfBbIHDEEY?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "sleepofangels-fan":
			...
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/IPQU3lbIGXc?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
#mists
		case "unaware":
			...
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/2uxlUjEJ_AM?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "failure":
			$stitle="&ldquo;Failure&rdquo; (Live 2000)";
			$sdesc="Filmed at Downtime in New York City on December 2, 2000 by Chris Flam.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/Z32HiotiBs8?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "everythingsheis":
			$stitle="&ldquo;Every Thing She Is&rdquo; (Live 2004)";
			$sdesc="Filmed at Elysium in Austin, TX on August 30, 2004.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/OQsWbpz_DkM?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
#asphodel
		case "masks":
			$stitle="&ldquo;Masks&rdquo; (Live 2002)";
			$sdesc="Filmed at Elysium in Austin, TX on October 25, 2002 by Chad R. Miller.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/pmMwjDolmZA?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "outside":
			$stitle="&ldquo;Outside&rdquo; (Live 2004)";
			$sdesc="Filmed at Elysium in Austin, TX on August 30, 2004.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/TyHD66Bbnmg?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "outside-amv":
			...
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/OWzXeNEMINI?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "time":
			$stitle="&ldquo;Time&rdquo; (Live 2002)";
			$sdesc="Filmed at Elysium in Austin, TX on October 25, 2002 by Chad R. Miller.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/NZmKJ-DpNyc?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "open2020":
			$stitle="&ldquo;Open (Reimagined)&rdquo;";
			$sdesc="Official music video for &quot;Open (Reimagined)&quot; by the Machine in the Garden.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/HVBhITDwX0Y?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
#shadow puppets
		case "thissilence":
			$stitle="&ldquo;This Silence&rdquo; (Live 2005)";
			$sdesc="Filmed at Convergence 11 (4th and B) in San Diego, CA on April 23, 2005.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/RuV0HXFG-iU?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "theinsideworld":
			$stitle="&ldquo;The Inside World&rdquo; (Live 2005)";
			$sdesc="Filmed at Convergence 11 (4th and B) in San Diego, CA on April 23, 2005.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/ICGQ3GID2ak?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "suspend":
			$stitle="&ldquo;Suspend&rdquo; (Live 2004)";
			$sdesc="Filmed at Elysium in Austin, TX on August 30, 2004.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/DzzpbLliBdI?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
#xv
#before and after the storm
		case "cimmerian":
			...
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/dRxiGUmvh3U?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
		case "vanir":
			$stitle="&ldquo;In the Vanir&rdquo; (Live 2013)";
			$sdesc="Filmed at Elysium in Austin, TX on November 30, 2013.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/lPiHYGcsz1A?rel=0" frameborder="0" allowfullscreen></iframe>';
			break;
#places in between
		case "teaser":
			...
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/o1ai_xl0Lcw" frameborder="0" allowfullscreen></iframe>';
			break;
		case "coldstorm":
			$stitle="&ldquo;Cold Storm&rdquo; Official Video";
			$sdesc="Official music video for &quot;Cold Storm&quot; by the Machine in the Garden.";
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/V3_HSV_WwZE" frameborder="0" allowfullscreen></iframe>';
			break;
		case "athousandyears":
			...
			$siframe='<iframe title="YouTube: '.$stitle.'" width="480" height="360" src="https://www.youtube.com/embed/KsTb1hgZ0io" frameborder="0" allowfullscreen></iframe>';
			break;
		case "findaway":
