...
<div id="discog_albuminfo" tabindex="-1">
	<img src="albums/sogrey.jpg" alt="Shades of Grey" width="256" height="250">
	<h1>Shades of Grey</h1>
	<p class="notopmargin">GRINDINGintoEMPTINESS webzine &copy;1998</p>
...
<table>
	...
	<td>tMitG track:</td>
	<td>
	Corpus Christi (love will die)
	</td>
	<td>
	<?php do_lyrics("corpuschristi"); ?>
	</td>
	<td></td>
	<td></td>
	</tr>
