...
<head>
	...
	<meta name="description" content="Audio samples and video clips from the Machine in the Garden's full discography.">
...
$(document).ready(function() {
    ...
    $("#songlist div.songs.impermanence").show();
    $("#accordion .item").addClass('fade').attr("tabindex", "-1");
    $("#accordion .impermanence").removeClass('fade').attr("aria-selected", "true").attr("tabindex", "0");
