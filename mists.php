...
<section id="discog_albuminfo">
	<div><img src="albums/mists.jpg" alt="Out of the Mists" class="albumimg" itemprop="image" /></div>
...
<section>
	<h2 id="reviews">Reviews of <em>Out of the Mists</em>:</h2>
